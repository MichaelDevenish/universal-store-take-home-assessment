...
describe('catalog service', () => {
  test('expect catalog to return items', async () => {
    ...
    expect(await fetchCatalog()).toMatchObject([
      {sku: "111111", title: "T-Shirt", price: "12.99", imageUrl: 'testImage'},
      {sku: "222222", title: "Jeans", price: "40", imageUrl: 'testImage1'},
      {sku: "333333", title: "Shoes", price: "19.99", imageUrl: 'testImage2'}
    ])
  });
});